...
export const Route = createFileRoute("/_authenticated/setup/android")({
  ...
  head: () => ({
    meta: [
      { title: "Android OAuth setup · V-V-Chronos" },
      { name: "description", content: "Save your Android package name, SHA-1 fingerprints and Google OAuth client IDs for V-V-Chronos." },
      { property: "og:title", content: "Android OAuth setup · V-V-Chronos" },
