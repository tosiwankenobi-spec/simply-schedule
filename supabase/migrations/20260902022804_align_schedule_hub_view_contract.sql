-- Align the remote schedule hub view with the application contract.
-- Views contain no data, so recreate only this API surface while preserving
-- the underlying appointments table and its RLS policies.
